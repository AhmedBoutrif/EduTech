...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.mZ5tFhU'] ?? $container->load('get_ServiceLocator_MZ5tFhUService'))->withContext('App\\Controller\\ReservationController', $container));
