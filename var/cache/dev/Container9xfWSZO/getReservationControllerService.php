...
class getReservationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.282XHtU'] ?? $container->load('get_ServiceLocator_282XHtUService'))->withContext('App\\Controller\\ReservationController', $container));
