...
class __TwigTemplate_68dc66250826a0acbdaf00c1c9945ada extends Template
{
    ...
    <div class=\"container mt-5\">
        ...
        yield "
                ...
                <div class=\"mb-3\">
                    ";
        // line 36
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 36, $this->source); })()), "certificat", [], "any", false, false, false, 36), 'label', ["label" => "Certificat associé"]);
        yield "
                    ";
        // line 37
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "certificat", [], "any", false, false, false, 37), 'widget', ["attr" => ["class" => "form-control"]]);
        yield "
                    ";
        // line 38
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 38, $this->source); })()), "certificat", [], "any", false, false, false, 38), 'errors');
        yield "
                </div>
        ...
        if ((array_key_exists("cours", $context) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["cours"]) || array_key_exists("cours", $context) ? $context["cours"] : (function () { throw new RuntimeError('Variable "cours" does not exist.', 44, $this->source); })()), "id", [], "any", false, false, false, 44)))) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cours_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["cours"]) || array_key_exists("cours", $context) ? $context["cours"] : (function () { throw new RuntimeError('Variable "cours" does not exist.', 45, $this->source); })()), "id", [], "any", false, false, false, 45)]), "html", null, true);
    ...
    <div class=\"container mt-5\">
        <div class=\"row justify-content-center\">
            <div class=\"col-md-6\">
                ...
                <div class=\"mb-3\">
                    {{ form_label(form.certificat, 'Certificat associé') }}
                ...
                <div class=\"d-flex justify-content-between\">
                    ...
                    {% if cours is defined and cours.id is not null %}
                        <form method=\"post\" action=\"{{ path('app_cours_delete', {'id': cours.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer ce cours ?');\">
...
{% endblock %}
", "cours/edit.html.twig", "C:\\Users\\User\\Desktop\\edutech - Copie (5) - Copie\\templates\\cours\\edit.html.twig");
    }
}
