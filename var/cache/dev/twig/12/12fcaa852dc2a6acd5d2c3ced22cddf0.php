...
/* quiz/show.html.twig */
class __TwigTemplate_ea13c8abe3ed099ba4cee846acacc9c0 extends Template
{
    ...
    public function block_main(array $context, array $blocks = []): iterable
    {
        ...
        // line 43
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["reponseUtilisateur"]) || array_key_exists("reponseUtilisateur", $context) ? $context["reponseUtilisateur"] : (function () { throw new RuntimeError('Variable "reponseUtilisateur" does not exist.', 43, $this->source); })()));
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["reponse"]) {
            // line 44
            yield "                        <li class=\"list-group-item\">";
    ...
    <div class=\"container mt-4\">
        <div class=\"card mx-auto\" style=\"max-width: 80%;\">
            ...
            <div class=\"card-body\">
                ...
                <h3 class=\"mt-4\">Réponses Utilisateur :</h3>
                <ul class=\"list-group\">
                    {% for reponse in reponseUtilisateur %}
                        <li class=\"list-group-item\">{{ reponse }}</li>
                    {% else %}
                ...
                <div class=\"text-center mt-4\">
                    <a href=\"{{ path('app_quiz_index') }}\" class=\"btn btn-primary\">Retour à la liste</a>
                </div>
            </div>
        </div>
    </div>
{% endblock %}
", "quiz/show.html.twig", "C:\\Users\\ahmed\\Videos\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\quiz\\show.html.twig");
    }
}
