...
/* certification/liste.html.twig */
class __TwigTemplate_f9f93ebc81b731bc036202805be46302 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "certification/liste.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "certification/liste.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "certification/liste.html.twig", 1);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["certification"]) {
            ...
            yield "                    </td>
                    <td>
                        ...
                        <a href=\"";
            // line 86
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["certification"], "id", [], "any", false, false, false, 86)]), "html", null, true);
            yield "\" class=\"btn btn-info btn-sm\" title=\"Voir\">
                            <i class=\"bi bi-eye\"></i> Voir
                        </a>
                        <a href=\"";
            // line 89
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["certification"], "id", [], "any", false, false, false, 89)]), "html", null, true);
            yield "\" class=\"btn btn-warning btn-sm\" title=\"Éditer\">
                        ...
                        <form action=\"";
            // line 93
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["certification"], "id", [], "any", false, false, false, 93)]), "html", null, true);
            ...
            if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["certification"], "questions", [], "any", false, false, false, 100))) {
                // line 101
                yield "                            <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_play", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["certification"], "id", [], "any", false, false, false, 101)]), "html", null, true);
...
";
    ...
    {
        return "certification/liste.html.twig";
    }
...
{% block main %}
        ...
        <table class=\"table table-striped table-sm mx-auto\" style=\"max-width: 80%;\">
            ...
            {% for certification in certifications %}
                <tr>
                    ...
                    <td>
                        <!-- Boutons d'action avec texte et icônes Bootstrap -->
                        <a href=\"{{ path('app_certification_show', {'id': certification.id}) }}\" class=\"btn btn-info btn-sm\" title=\"Voir\">
                            <i class=\"bi bi-eye\"></i> Voir
                        </a>
                        <a href=\"{{ path('app_certification_edit', {'id': certification.id}) }}\" class=\"btn btn-warning btn-sm\" title=\"Éditer\">
                            <i class=\"bi bi-pencil\"></i> Éditer
                        </a>
                        <!-- Bouton de suppression avec confirmation -->
                        <form action=\"{{ path('app_certification_delete', {'id': certification.id}) }}\" method=\"post\" style=\"display: inline;\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette certification ?');\">
                            <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
                            <button type=\"submit\" class=\"btn btn-danger btn-sm\" title=\"Supprimer\">
                                <i class=\"bi bi-trash\"></i> Supprimer
                            </button>
                        ...
                        <!-- Bouton Jouer -->
                        {% if certification.questions is not empty %}
                            <a href=\"{{ path('app_certification_play', {'id': certification.id}) }}\" class=\"btn btn-primary btn-sm mt-2\" title=\"Jouer\">
                                <i class=\"bi bi-play-circle\"></i> Jouer
                            </a>
                        {% endif %}
                    </td>
    ...
    <div class=\"text-center\">
        <a href=\"{{ path('app_certification_new') }}\" class=\"btn btn-success\">Créer une nouvelle certification</a>
    </div>
{% endblock %}", "certification/liste.html.twig", "C:\\Users\\ahmed\\Videos\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\certification\\liste.html.twig");
    }
}
