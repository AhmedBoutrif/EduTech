...
class __TwigTemplate_0a8855b8a802dd05825e48e5a1d9b55f extends Template
{
    ...
    <table class=\"table\">
        ...
        <td>";
            // line 28
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["question"], "certificat", [], "any", false, false, false, 28)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["question"], "certificat", [], "any", false, false, false, 28), "id", [], "any", false, false, false, 28), "html", null, true)) : ("N/A"));
            yield "</td>
        <td>
            <a href=\"";
            // line 30
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_question_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["question"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            yield "\" class=\"btn btn-info\">Voir</a>
            <a href=\"";
            // line 31
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_question_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["question"], "id", [], "any", false, false, false, 31)]), "html", null, true);
...
{% block main %}
    ...
    <tr>
        ...
        <td>{{ question.certificat ? question.certificat.id : 'N/A' }}</td>
        <td>
            <a href=\"{{ path('app_question_show', {'id': question.id}) }}\" class=\"btn btn-info\">Voir</a>
...
{% endfor %}
    ...
    <a href=\"{{ path('app_question_new') }}\" class=\"btn btn-success\">Créer une nouvelle question</a>
{% endblock %}", "question/index.html.twig", "C:\\Users\\User\\Desktop\\edutech - Copie (5) - Copie\\templates\\question\\index.html.twig");
    }
}
