...
/* user/new.html.twig */
class __TwigTemplate_4903d587cda6088ed9f550778c47b765 extends Template
{
                ...
                <div class=\"col-lg-6 col-md-8\">
                    <div class=\"card shadow-lg border-0 rounded-4 bg-dark text-white\">
                        <div class=\"card-body p-5\">
                            <h2 class=\"card-title text-center mb-4 text-warning fw-bold\">Create New User</h2>
                            
                            ";
        // line 15
        yield "                            ";
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), 'form_start', ["attr" => ["novalidate" => "novalidate", "class" => "needs-validation"]]);
        yield "
...
";
    ...
    {
        return array (  130 => 28,  122 => 21,  116 => 18,  110 => 15,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Create New User - Append{% endblock %}
                ...
                <div class=\"col-lg-6 col-md-8\">
                    <div class=\"card shadow-lg border-0 rounded-4 bg-dark text-white\">
                        <div class=\"card-body p-5\">
                            ...
                            {# Start the form and disable HTML5 validation #}
                            {{ form_start(form, {'attr': {'novalidate': 'novalidate', 'class': 'needs-validation'}}) }}
                                
                                {# Include the form fields with error messages #}
...
{% endblock %}", "user/new.html.twig", "C:\\Users\\ahmed\\Videos\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\user\\new.html.twig");
    }
}
