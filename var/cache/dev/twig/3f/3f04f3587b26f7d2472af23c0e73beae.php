...
class __TwigTemplate_d8fb61e2643de1ee627d6c95b312d58a extends Template
{
...
<div class=\"recent-posts-widget widget-item\">
    ...
    ";
        // line 131
        if (((isset($context["certification"]) || array_key_exists("certification", $context) ? $context["certification"] : (function () { throw new RuntimeError('Variable "certification" does not exist.', 131, $this->source); })()) &&  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, (isset($context["certification"]) || array_key_exists("certification", $context) ? $context["certification"] : (function () { throw new RuntimeError('Variable "certification" does not exist.', 131, $this->source); })()), "questions", [], "any", false, false, false, 131)))) {
            // line 132
            yield "        <div class=\"post-item\">
            <div>
                <h4>
                    <a href=\"";
            // line 135
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_play", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["certification"]) || array_key_exists("certification", $context) ? $context["certification"] : (function () { throw new RuntimeError('Variable "certification" does not exist.', 135, $this->source); })()), "id", [], "any", false, false, false, 135)]), "html", null, true);
            yield "\">
                        ";
            // line 136
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["certification"]) || array_key_exists("certification", $context) ? $context["certification"] : (function () { throw new RuntimeError('Variable "certification" does not exist.', 136, $this->source); })()), "nom", [], "any", false, false, false, 136), "html", null, true);
            yield " <!-- Afficher le nom du certificat -->
                    </a>
                </h4>
                <!-- Bouton Jouer -->
                <a href=\"";
            // line 140
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_certification_play", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["certification"]) || array_key_exists("certification", $context) ? $context["certification"] : (function () { throw new RuntimeError('Variable "certification" does not exist.', 140, $this->source); })()), "id", [], "any", false, false, false, 140)]), "html", null, true);
...
";
    ...
    {
        return array (  289 => 148,  285 => 146,  276 => 140,  269 => 136,  265 => 135,  260 => 132,  258 => 131,  250 => 125,  246 => 123,  243 => 122,  230 => 115,  226 => 114,  221 => 111,  216 => 110,  214 => 109,  199 => 97,  168 => 69,  137 => 41,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"recent-posts-widget widget-item\">
    ...
    {% if certification and certification.questions is not empty %}
        <div class=\"post-item\">
            <div>
                <h4>
                    <a href=\"{{ path('app_certification_play', {'id': certification.id}) }}\">
                        {{ certification.nom }} <!-- Afficher le nom du certificat -->
                    </a>
                </h4>
                <!-- Bouton Jouer -->
...
{% endblock %}", "cours/blog-details.html.twig", "C:\\Users\\User\\Desktop\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\cours\\blog-details.html.twig");
    }
}
