...
class __TwigTemplate_9ee47651bdcbca852faabdbf08a63eeb extends Template
{
    ...
    <div class=\"container mt-5\">
        <div class=\"row justify-content-center\">
            <div class=\"col-md-6\">
                ...
                <div class=\"text-center mt-4\">
                    <a href=\"{{ path('app_question_index') }}\" class=\"btn btn-secondary\">Retour à la liste</a>
                </div>

                <div class=\"text-center mt-3\">
                    <form method=\"post\" action=\"{{ path('app_question_delete', {'id': question.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette question ?');\">
...
{% endblock %}
", "question/edit.html.twig", "C:\\Users\\ahmed\\Videos\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\question\\edit.html.twig");
    }
}
