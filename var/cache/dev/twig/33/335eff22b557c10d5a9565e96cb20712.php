...
class __TwigTemplate_6305072f4a28c939f3dc9662895b6544 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("baseB.html.twig", "back/quiz/index.html.twig", 2);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"text-center mb-4\">
            <a href=\"";
        // line 12
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizb_statistiques");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["quiz"]) {
            ...
            yield "</td>
                            <td>
                                <div class=\"d-flex flex-column gap-2\">
                                    ...
                                    <a href=\"";
            // line 76
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizb_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["quiz"], "id", [], "any", false, false, false, 76)]), "html", null, true);
            yield "\" class=\"btn btn-warning btn-sm\" title=\"Éditer\">
                                        <i class=\"bi bi-pencil\"></i> Éditer
                                    </a>
                                    <form method=\"post\" action=\"";
            // line 79
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizb_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["quiz"], "id", [], "any", false, false, false, 79)]), "html", null, true);
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["quiz"], "questions", [], "any", false, false, false, 86)) > 0)) {
                // line 87
                yield "                                        <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizb_play", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["quiz"], "id", [], "any", false, false, false, 87)]), "html", null, true);
        ...
        <div class=\"text-center mt-4\">
            <a href=\"";
        // line 104
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizb_new");
...
{% block body %}
    <div class=\"container\">
        ...
        <!-- Bouton pour afficher les statistiques globales -->
        <div class=\"text-center mb-4\">
            <a href=\"{{ path('app_quizb_statistiques') }}\" class=\"btn btn-secondary\">
                <i class=\"bi bi-bar-chart\"></i> Voir les statistiques globales
            </a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class=\"d-flex flex-column gap-2\">
                                    ...
                                    <form method=\"post\" action=\"{{ path('app_quizb_delete', {'id': quiz.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer ce quiz ?');\">
        ...
        <div class=\"text-center mt-4\">
            <a href=\"{{ path('app_quizb_new') }}\" class=\"btn btn-success\">
                <i class=\"bi bi-plus-circle\"></i> Créer un nouveau quiz
            </a>
        </div>
    </div>
{% endblock %}", "back/quiz/index.html.twig", "C:\\Users\\ahmed\\Videos\\Z-Boutrif\\edutech_1\\edutech_1\\edutech\\templates\\back\\quiz\\index.html.twig");
    }
}
