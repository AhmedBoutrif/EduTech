...
class __TwigTemplate_961d721e7b14e6f3ad36d6da5c81a3e7 extends Template
{
    ...
    <div class=\"text-center mb-4\">
        ...
        <a href=\"";
        // line 11
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cours_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["cours"]) || array_key_exists("cours", $context) ? $context["cours"] : (function () { throw new RuntimeError('Variable "cours" does not exist.', 11, $this->source); })()), "id", [], "any", false, false, false, 11)]), "html", null, true);
    ...
    <div class=\"table-responsive mt-5\">
        ...
        yield "                    </td>
                ...
                <tr>
                    ...
                    <td>";
        // line 48
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["cours"]) || array_key_exists("cours", $context) ? $context["cours"] : (function () { throw new RuntimeError('Variable "cours" does not exist.', 48, $this->source); })()), "certificat", [], "any", false, false, false, 48), "id", [], "any", false, false, false, 48), "html", null, true);
        yield "</td>
                </tr>
            </tbody>
        </table>
...
{% block main %}
    ...
    <!-- Boutons Retour et Modifier en haut -->
    <div class=\"text-center mb-4\">
        <a href=\"{{ path('app_cours_index') }}\" class=\"btn btn-primary\">Retour à la liste</a>
...
{% endblock %}
", "cours/show.html.twig", "C:\\Users\\User\\Desktop\\edutech - Copie (5) - Copie\\templates\\cours\\show.html.twig");
    }
}
