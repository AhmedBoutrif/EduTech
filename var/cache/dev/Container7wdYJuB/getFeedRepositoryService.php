 ...
 */
class getFeedRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FeedRepository' shared autowired service.
     *
     * @return \App\Repository\FeedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FeedRepository.php';

        return $container->privates['App\\Repository\\FeedRepository'] = new \App\Repository\FeedRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
